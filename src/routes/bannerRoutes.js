...
// Rotas para banners
routerBanner.post('/create',checkToken,upload.single('imagem'),validateImage, bannerController.createBanner);
...
routerBanner.put('/:id',checkToken, upload.single('imagem'),validateImage, bannerController.updateBanner);
