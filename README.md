...
* **Status:** Implementado.
#### Atualização de Time
* **Entradas:** ID do time por parametro, Nome, logo e ID do Usuario criador do Time.
...
* **Entradas:** Nenhuma..
* **Saídas:** JSON com todos os Usuários cadrastrado no DB.
* **Restrições:** Autenticação via token, senha não deve retornar, retornar os atributos dos Usuários.
* **Status:** Implementado.
#### Retorno de Usuários por ID
* **Entradas:** ID do Usuários por parametro.
* **Saídas:** JSON com todos os Usuários cadrastrado no DB.
* **Restrições:** Autenticação via token, senha não deve retornar, retornar os atributos dos Usuários.
* **Status:** Implementado.
### Retorno Usuários por nome
* **Entradas:** Nome do Usuários por parametro.
* **Saídas:** JSON com todos os Usuários que posuem o nome cadrastrado no DB.
* **Restrições:** Autenticação via token, senha não deve retornar, retornar os atributos dos Usuários.
* **Status:** Implementado.
...
**Restrições:** Partida deve ser única. Partida deve ter dois time.
* **Status:** Implementado.
#### Controle de pontos
...
## Atualizações
Este documento será atualizado sempre que houver alterações no projeto.
## Público-alvo
